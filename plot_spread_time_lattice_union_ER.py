...
#
#     plt.figure(1, (7, 6))
#     address = theory_simulation_pickle_address.replace('Z2_union_ER/', 'Z4/')
#     spread_time_avgs_benchmark = pickle.load(open(address
#                                                   + 'Z4'
#                                                   + '_spread_time_avgs.pkl', 'rb'))
#
#     spread_time_stds_benchmark = pickle.load(open(address
#                                                   + 'Z4'
#                                                   + '_spread_times_std.pkl', 'rb'))
#
#     qs_benchmark = pickle.load(open(address
#                                     + 'Z4'
#                                     + '_qs.pkl', 'rb'))
#
#     for model in models_list:
