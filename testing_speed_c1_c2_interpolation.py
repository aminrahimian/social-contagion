...
if __name__ == '__main__':
    ...
    if settings.do_computations:
        for eta in etas:
            ...
            dynamics = DeterministicLinear(params_alpha_10)
            ...
            dynamics = DeterministicLinear(params_alpha_80)
            speed, std, _, _ = dynamics.avg_speed_of_spread(dataset_size=size_of_dataset, mode='total')
            ...
            # }
            #
            # dynamics = DeterministicLinear(params_alpha_150)
            # speed, std, _, _ = dynamics.avg_speed_of_spread(dataset_size=size_of_dataset, mode='total')
        ...
        if settings.save_computations:
            pickle.dump(speeds_alpha_10,open( './data/speeds_alpha_10_all_along.pkl','wb'))
            pickle.dump(speeds_alpha_60, open('./data/speeds_alpha_60_all_along.pkl', 'wb'))
            pickle.dump(speeds_alpha_80, open('./data/speeds_alpha_80_all_along.pkl', 'wb'))
            # pickle.dump(speeds_alpha_150, open('./data/speeds_alpha_150_all_along.pkl', 'wb'))

            pickle.dump(speeds_std_alpha_10,open( './data/speeds_std_alpha_10_all_along.pkl','wb'))
            pickle.dump(speeds_std_alpha_60, open('./data/speeds_std_alpha_60_all_along.pkl', 'wb'))
            pickle.dump(speeds_std_alpha_80, open('./data/speeds_std_alpha_80_all_along.pkl', 'wb'))
            # pickle.dump(speeds_std_alpha_150, open('./data/speeds_std_alpha_150_all_along.pkl', 'wb'))

    if settings.do_plots:

        if settings.load_computations:
            speeds_alpha_10 = pickle.load(open('./data/speeds_alpha_10_all_along.pkl','rb'))
            speeds_alpha_60 = pickle.load(open('./data/speeds_alpha_60_all_along.pkl', 'rb'))
            speeds_alpha_80 = pickle.load(open('./data/speeds_alpha_80_all_along.pkl', 'rb'))
            # speeds_alpha_150 = pickle.load(open('./data/speeds_alpha_150_all_along.pkl', 'rb'))

            speeds_std_alpha_10 = pickle.load(open( './data/speeds_std_alpha_10_all_along.pkl', 'rb'))
            speeds_std_alpha_60 = pickle.load(open('./data/speeds_std_alpha_60_all_along.pkl', 'rb'))
            speeds_std_alpha_80 = pickle.load(open('./data/speeds_std_alpha_80_all_along.pkl', 'rb'))
            # speeds_std_alpha_150 = pickle.load(open('./data/speeds_std_alpha_150_all_along.pkl', 'rb'))
        ...
        if settings.save_plots:
            plt.savefig('./data/' + 'speed_of_contagion_c_1_c_2_interpolation_all_along.png')