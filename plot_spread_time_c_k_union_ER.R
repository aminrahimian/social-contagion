# file to plot figure S4 in https://arxiv.org/abs/1810.03579v4
# spread time of complex contagion over ck union ER random graphs  
# versus k and network size 
...
size_colors <- c(
  ...
  "1000" = brewer.pal(8, "Set1")[1],#[2],
  "3000" = brewer.pal(8, "Set1")[2],#[3],
  "5000" = brewer.pal(8, "Set1")[5]#[4]#,
...
ck_union_ER_vs_k_plot_line_error_bar <- ggplot(
  ...
  data = ck_union_ER_vs_kspreading_data%>%filter(network_size %in% c(1000,3000,5000))) +
...
k_colors <- c(
  "5" = brewer.pal(8, "Set1")[1],
  "6" = brewer.pal(8, "Set1")[2],
