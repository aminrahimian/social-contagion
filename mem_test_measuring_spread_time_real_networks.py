...
intervention_type = 'random-addition' #'none'  # 'rewiring' #'all'  # 'triad-addition'  # 'random-addition'# 'rewiring' #
...
def measure_rewiring_spread_time(network_id, rewiring_percentage):
    ...
    # print('mem_metrics:')
    # print('network_id is:', network_id)
    # print(sys.getsizeof(G.edges) + sys.getsizeof(G.nodes))
