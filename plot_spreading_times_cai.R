...
# load data
st <- read.csv(
  "data/cai-data/output/cai_edgelist_data_dump.csv",
  stringsAsFactors = FALSE
)

nd <- read.csv(
  "data/cai-data/output/cai_edgelist_clustering_data_dump.csv",
  stringsAsFactors = FALSE
)
...
ggsave('figures/time_to_spread_ecdf_overall.pdf',
...
ggsave('figures/time_to_spread_many_ecdfs.pdf',
...
ggsave('figures/time_to_spread_many_diff_in_ecdfs_random_vs_triadic.pdf',
...
ggsave('figures/time_to_spread_sample_networks_ecdfs.pdf',
